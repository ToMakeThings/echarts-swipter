...
(function() {
	(function() {
		...
		function Gc(a, b) {
			for (var c = a.split(M), d = b || Fc, e; e = c.shift();) if (S(d[e])) d = d[e];
			else return h;
			return d
		}
		...
		function Sc(a) {
			...
			if (c[F]) return b.k = Wc(c[0], c[1], c[2]),
			ca(b, hc),
			b;
		...
		R.mb = function(a, b) {
			...
			case Ta:
				...
				for (; b[0] + 1 < p && a[C](b[0] + 1) == N;) b[0]++, this.o++;
	...
	(function() {
		...
		function Sm(a, b) {
			for (var c = a[Pc](Ve), d = b || O, f; f = c.shift();) if (P(d[f])) d = d[f];
			else return k;
			return d
		}
		function Tm() {}
		...
		function mn(a) {
			if (O[Nd]) O[Nd](a, qg);
			else if (O.eval) if (nn == k && (O.eval(Bm), "undefined" != typeof O._et_ ? (delete O._et_, nn = i) : nn = l), nn) O.eval(a);
			else {
				var b = O[Nc],
					c = b[Pb](El);
				Ca(c, fm);
		...
		function lo(a, b) {
			for (var c = 1; c < arguments[B]; c++) {
				...
				else if (f) for (var h = a[B], j = d[B], o = 0; o < j; o++) a[h + o] = d[o];
				else a[s](d)
			}
		}
		function mo(a, b, c, d) {
		...
		function Ip(a, b, c) {
			...
			else for (a = a[Vb]; a;) Ip(a, b, c), a = a[oc]
		}
		function vp(a) {
			if (a && typeof a[B] == K) {
		...
		function Mp(a, b, c) {
			if (typeof a[Xb] == Mi) a[Xb](b, c);
				...
				else if (typeof a.Ja != Mi) if (Ym(a) || R(a)) {
					d = [];
		...
		function hq(a, b, c, d, f) {
			if (b) {
				...
				fq[o] || (fq[o] = []);
				fq[o][s](j);
				a.addEventListener ? (a == O || !a.Dg) && a.addEventListener(b, h, d) : a.attachEvent(b in gq ? gq[b] : gq[b] = Vk + b, h);
				return c
			}
		...
		function rq(a, b) {
			...
			if (l in d) if (j = d[l], j.la = j.m, c) for (o = 0; !b.Rb && o < h[B] && j.la; o++) sa(b, h[o]), f &= pq(j, h[o], b[z], l, b) && b.Lc != l;
			else for (d = a; !b.Rb && d && j.la; d = d.md) sa(b, d), f &= pq(j, d, b[z], l, b) && b.Lc != l;
			return Boolean(f)
		}
				...
				try {
					if (o) {
						...
						if (r) {
							j = f[l];
							j.la = j.m;
							for (ia = 0; !w.Rb && ia < L[B] && j.la; ia++) sa(w, L[ia]), h &= pq(j, L[ia], d, l, w)
						}
					} else h = qq(c, w)
				} finally {
					L && Ma(L, 0), w.Q()
		...
		N.lh = function() {
			if (this.eb && "undefined" != typeof Rm && (!this.od[1] || !(4 == this.Kc() && 2 == this.df()))) if (this.ld && 4 == this.Kc()) uq[Lc](jn(this.cg, this), 0);
		...
		N.Pj = function(a) {
			...
			if (c) b.yc(a.Qa);
				...
				if (d[pb](0) != Ye) if (this.xe() && !this.ug()) d = Ye + d;
				else {
		...
		N.Tb = function() {
			...
			for (var a = this.z.Ja(), b = this.z.Tb(), c = [], d = 0; d < b[B]; d++) {
				var f = a[d];
				if (Q(f)) for (var h = 0; h < f[B]; h++) c[s](b[d]);
				else c[s](b[d])
			}
			return c
		};
		N.Ja = function(a) {
			...
			else for (var b = this.z.Ja(), a = [], c = 0; c < b[B]; c++) {
				var d = b[c];
				Q(d) ? lo(a, d) : a[s](d)
			}
			return a
		...
		N.toString = function() {
			...
			for (var a = [], b = 0, c = this.z.Tb(), d = 0; d < c[B]; d++) {
				var f = c[d],
					h = En(f),
					f = this.z.get(f);
				if (Q(f)) for (var j = 0; j < f[B]; j++) 0 < b && a[s](fe), a[s](h), f[j] !== J && a[s](Cf, En(f[j])), b++;
		...
		N.getFormattedValue = function(a, b) {
			...
			var c = this.Nc(a, b),
				d = J;
			if (c) if ("undefined" != typeof c.f && c.f != k) d = c.f;
		...
		N.insertRows = function(a, b) {
			...
			for (var d = [], f = 0; f < c[B]; f++) {
				var h = c[f],
					j = [];
				if (h === k) for (h = 0; h < this.B[B]; h++) j[s]({
					v: k,
					f: k
				});
				else if (Q(h)) {
					h[B] != this.B[B] && e(n("Row given with size different than " + this.B[B] + " (the number of columns in the table)."));
		...
		N.Nj = function(a) {
			...
			for (var j in b) {
				...
				if (!h) c = {}, c.name = j, c.pf = j + Cf + aa(d), f[s](c)
			}
			b = a;
			if (0 < f[B]) {
				b += Ef;
		...
		function yr(a) {
			...
			a = ca(a),
			c = ca(c),
			(la(f) || 0 > f || 255 < f || la(a) || 0 > a || 255 < a || la(c) || 0 > c || 255 < c) && e(n('"(' + f + ue + a + ue + c + '") is not a valid RGB color')),
			f = Cr(f[yc](16)),
			a = Cr(a[yc](16)),
			c = Cr(c[yc](16)),
			b.Hf = ae + f + a + c,
		...
		function Rr(a) {
			...
			if (a[$a]) b = Or(a), a = ip(c).ac(), h.x = b[y] + a.x, h.y = b.top + a.y;
				...
				if (Ko || Mo && d == lh) h.y -= c[ad][Jd];
				for (b = a;
				(b = Pr(b)) && b != c[ad] && b != j;) if (h.x -= b[qd], !Ko || b[Cd] != Sg) h.y -= b[xc]
			}
			return h
		}
		function Tr(a, b, c) {
			...
			if (!f[Hb] && !h[Hb] && !j[Hb] && !o[Hb]) if (a == Of) {
				...
				for (var o = [new Pp, new Pp], r = b && b[rb]() || 0, w = 0; w < r; w++) if (b[Ub](w) == K) {
					...
					if (!An(C)) {
						var L;
						L = w;
						0 == L ? L = k : (L--, L = ((c.series || {})[L] || {}).targetAxisIndex || 0);
						Xm(L) || o[L].add(C)
					}
				}
				o[0] = As(o[0]);
		...
		N.mk = function() {
			...
			} else if (Q(b)) for (c = 0; c < b[B]; c++) a = google[E][md].fromJSON(a, b[c]);
		...
		function Ls(a, b, c, d, f) {
			...
			if (a) {
				...
				this.C = c;
				this.M = d;
				if (1 == a[ib] && a[Cd] != Lf) if (a = a[hc], b = a[b]) this.I = b, this.N = 0;
				else {
		...
		N.X = function(a, b, c, d, f) {
			if (Q(b)) for (var h = 0; h < b[B]; h++) this.X(a, b[h], c, d, f);
			else {
				a: {
					c = c || this;
					f = f || this.Pg || this;
		...
		N.ag = function(a) {
			...
			if (this.vb && !this.kb && (!b || a.ne())) {
				this.Be(a);
				if (0 == this.qg) if (this.rg(a), this.kb) a[ub]();
				else return;
				else a[ub]();
				this.Ki();
		...
		N.Ai = function(a, b, c) {
			if (c != this.re(b)) if (c ? gp(b, yj) : hp(b, yj), b = this.S(b), c) c = this.fd(1), b[vb](a.t().d(ti, c), b[Vb] || k);
			else b[bd](b[Vb])
		};
		N.kd = function(a) {
			switch (a) {
			...
			if (C.o != L.o) {
				...
				do {
					...
					if (db == L) Ja = Rr(Da);
						...
						var ma = Da;
						Ja = new Ln;
						if (1 == ma[ib]) if (ma[$a]) ma = Or(ma), Ja.x = ma[y], Ja.y = ma.top;
						else {
							var ra = ip(ma).ac(),
								ma = Rr(ma);
							Ja.x = ma.x - ra.x;
			...
			a: {
				...
				if (j) {
					if (H) {
						...
						h.y >= H.top && h.y + o[I] > H[ud] && j & 32 && (Wa(o, q.max(o[I] - (h.y + o[I] - H[ud]), 0)), f |= 8);
		...
		N.Ba = function(a) {
			...
			case 40:
				...
				break;
			case 39:
				if (this.gc == Rj) this.le() ? this.Se() : this.Re();
				else return l;
				break;
			default:
				return l
		...
		m("google.visualization.data.join", function(a, b, c, d, f, h) {
			...
			for (var db = l, Da = 0, Ja = 0, ma = 0; Da < ta[B] || Ja < ia[B];) {
				var ra = 0,
					Aa = [];
				if (Ja >= ia[B]) if (j) Aa[0] = ta[Da], ra = -1;
				else break;
				else if (Da >= ta[B]) if (o) Aa[1] = ia[Ja], ra = 1;
				else break;
				else {
					Aa[0] = ta[Da];
					Aa[1] = ia[Ja];
				...
				if (db && 0 != ra) db = l, Ja++;
					...
					if (-1 == ra && j || 1 == ra && o || 0 == ra) {
						...
						co(d, function(a, b) {
							c == Li ? r[Ic](ma, b, Oe[A](Aa[ec], a[ec])) : r[jc](ma, b, Oe[A](Aa[ec], a[ec]), Oe[Fd](Aa[ec], a[ec]), Oe[Fc](Aa[ec], a[ec]))
						});
						if (-1 == ra && j || 0 == ra) {
							var nk = d[B];
							co(f, function(b, c) {
	...
	(function() {
		...
		function ep(a, b) {
			for (var c = a[qc](me), d = b || dp, e; e = c.shift();) if (W(d[e])) d = d[e];
			else return l;
			return d
		}
		function fp() {}
		...
		function Zp(a, b) {
			for (var c = 1; c < arguments[I]; c++) {
				...
				else if (e) for (var f = a[I], g = d[I], i = 0; i < g; i++) a[f + i] = d[i];
				else a[v](d)
			}
		}
		function $p(a, b, c) {
		...
		function Qr(a, b, c, d, e) {
			if (b) {
				...
				Or[i] || (Or[i] = []);
				Or[i][v](g);
				a.addEventListener ? (a == dp || !a.np) && a.addEventListener(b, f, d) : a.attachEvent(b in Pr ? Pr[b] : Pr[b] = kl + b, f);
				return c
			}
				...
				try {
					if (i) {
						...
						if (j) {
							g = e[n];
							g.rc = g.Ua;
							for (y = 0; !m.Ge && y < q[I] && g.rc; y++) wa(m, q[y]), f &= Yr(g, q[y], d, n, m)
						}
					} else f = Zr(c, m)
				} finally {
					q && Ga(q, 0), m.cc()
		...
		function ss(a) {
			...
			if (a[Ya]) b = ps(a), a = br(c).Oi(), f.x = b[C] + a.x, f.y = b.top + a.y;
				...
				for (b = a;
				(b = qs(b)) && b != c[Bc] && b != g;) if (f.x -= b[Nc], !Gq || b[Vc] != Wf) f.y -= b[$b]
			}
			return f
		}
		function us(a, b) {
			...
			if (o.nb != q.nb) {
				...
				do {
					...
					if (D == q) L = ss(Y);
						...
						var X = Y;
						L = new $;
						if (1 == X[cb]) if (X[Ya]) X = ps(X), L.x = X[C], L.y = X.top;
						else {
							var G = br(X).Oi(),
								X = ss(X);
							L.x = X.x - G.x;
		...
		function Ds(a, b, c, d, e, f, g) {
			...
			xa(b[zc], us(a, e));
			b[zc].top = us(f, e);
			if (!(c == g || (!c || !g ? 0 : c[w] == g[w] && c[Q] == g[Q]))) a = br(dr(b)).Kl(), Hq && (!a || !Wq(Ue)) ? (c = b[zc], a ? (Hq ? (a = zs(b, ul), e = zs(b, vl), f = zs(b, wl), d = zs(b, tl), a = new hs(f, e, d, a)) : (a = ms(b, ul), e = ms(b, vl), f = ms(b, wl), d = ms(b, tl), a = new hs(ha(f), ha(e), ha(d), ha(a))), Hq ? (e = Bs(b, bh), f = Bs(b, eh), d = Bs(b, gh), b = Bs(b, $g), b = new hs(d, f, b, e)) : (e = ms(b, dh), f = ms(b, fh), d = ms(b, hh), b = ms(b, ah), b = new hs(ha(d), ha(f), ha(b), ha(e))), c.pixelWidth = g[w] - b[C] - a[C] - a[R] - b[R], c.pixelHeight = g[Q] - b.top - a.top - a[P] - b[P]) : (c.pixelWidth = g[w], c.pixelHeight = g[Q])) : (b = b[zc], Iq ? b.MozBoxSizing = Zg : Jq ? b.WebkitBoxSizing = Zg : b.boxSizing = Zg, oa(b, s.max(g[w], 0) + Ul), Ua(b, s.max(g[Q], 0) + Ul));
			return i
		};
		...
		function Ls(a, b, c) {
			...
			else if (typeof a.Je != T) if (kp(a) || np(a)) {
				d = [];
		...
		V.dispatchEvent = function(a) {
			...
			if (b in c) {
				...
				if (n in c) if (f = c[n], f.rc = f.Ua, b) for (g = 0; !a.Ge && g < e[I] && f.rc; g++) wa(a, e[g]), d &= Yr(f, e[g], a[F], n, a) && a.jh != n;
				else for (e = this; !a.Ge && e && f.rc; e = e.Bl) wa(a, e), d &= Yr(f, e, a[F], n, a) && a.jh != n;
				a = Boolean(d)
			} else a = k;
			return a
		};
		...
		V.zw = function() {
			if (!this.Jf && this.bl()) {
				...
				this.Jf = k;
				this.Tg ? (Tr(this.Tg, Ni, this.bp, n, this), this.Tg.play()) : this.bp()
			}
		};
		V.Pi = function(a) {
		...
		V.Dk = function(a, b) {
			if (0 != a[I]) if (0 == this.eb[I] ? this[rb](a[0].x, a[0].y) : this.G(a[0].x, a[0].y), b) for (var c = 1; c < a[I]; ++c) this.pi(b[c - 1][1].x, b[c - 1][1].y, b[c][0].x, b[c][0].y, a[c].x, a[c].y);
			else for (c = 1; c < a[I]; ++c) this.G(a[c].x, a[c].y)
		};
		V.close = function() {
			this.ac({
				type: Vh,
		...
		function lu(a, b) {
			...
			case Yg:
				return n;
			default:
				h(r("Error while comparing " + a + " and " + b + ": unexpected type of obj1 " + c))
			}
		}
		function mu(a) {
			if (lp(a)) {
		...
		function Ju(a, b, c, d, e) {
			...
			for (f = a[I] - 1; 1 <= f; f--) if (i = a[Zb](0, f) + ne, g = e(i), g <= c) return b[v](i), {
				Fe: k,
				Yb: g
			};
			b[v](ne);
		...
		V.Zu = function(a, b, c) {
			if (0 != a.c[I]) {
				...
				if (!d) {
					if (c) for (g = a.c[I] - 1; 0 <= g; g--) i = a.c[g].i, f.G(i.Hj, i.Ij), (i.Fj != i.Hj || i.Gj != i.Ij) && f.G(i.Fj, i.Gj);
					...
					if (c) {
						...
						if (f = g.oe(this.g)) {
							...
							i = a.qb;
							if (e || i) d = this.g.ja();
							if (e) for (g = 0; g < e.Ca[I]; g++) this.g.xa(e.Ca[g][Mb], e.Ca[g].b, d);
		...
		ew[K].ai = function() {
			var a = this.gl(),
				b;
			this.sd[B](a);
			do b = this.bc.fl(new bw(a), this.Fa.me(), this.Fa.le(), a), a = this.sd[oc]();
			while (!this.bc.Bo(b));
			return this.bc.Bi(b)
		};
		ew[K].gl = function() {
		...
		hw[K].ai = function() {
			...
			do a = this.sd.Ya(), b = this.bc.fl(new gw(a, this.xi), this.I.me(), this.I.le(), a), b = this.bc.nu(b);
			while (!this.bc.Bo(b));
			return this.bc.Bi(b)
		};
		hw[K].gl = function() {
			var a = this.I.pa(10 * this.xi),
				b;
			this.sd[B](1);
			do b = this.sd[oc](), b = this.I.pa(10 * this.xi * (b - 1) / b);
		...
		V.Zf = function(a) {
			...
			if (ip(this.Ac) || this.Ac == Pi) {
				...
				this.J.min != -p || this.J.max != p ? (this.Ac = Pi, this.J.min >= this.J.max && h(r("viewWindow.max must be greater than viewWindow.min"))) : (this.Ac == Pi && h(r('Option "viewWindowMode" was set to "explicit" but "viewWindow" was not specified.')), this.Ac = this.Lq);
		...
		V.jr = function(a, b) {
			...
			} else if (this.zd == pn) for (c = 0; c < this.cf[I]; c++) e = this.cf[c], d = this.af[e], d.qh && this.h.$c[v]({
				index: c,
				id: e,
				text: d.fj,
				b: new wt({
		...
		V.jn = function(a) {
			if (0 == this[ic]) {
				...
				var G = L[I];
				if (m) for (var aa = 1; aa < m.pf; aa++) L[v]({
					key: Ln,
					min: c + u,
					T: [D - u]
				});
				...
				if (0 < i[I]) {
					...
					this[J].K = j.aa ? f : S;
					for (aa = 0; aa < i[I]; aa++) Da += i[aa], this[J].Pa = Ni, this[J].d[v]({
						x: a.a[C] + a.a[w] / 2,
						y: Da,
						length: a.a[w],
						text: j.d[aa]
		...
		V.ps = function() {
			...
			a.Th = [];
			a.mf = {};
			for (d = 0; d < a.e[I]; ++d) c = a.e[d], a.Th[v](c.Ja), e = a.mf[c.Ja], W(e) ? e != c[Fc] && h("All series on a given axis must be of the same data type") : a.mf[c.Ja] = c[Fc], a.gb[c[F]] = (a.gb[c[F]] || 0) + 1;
			aq(a.Th);
			a.$c = [];
		...
		function gx(a, b) {
			...
			i = d[0][Fc];
			for (g = 0; g < c[I]; ++g) {
				d[I] <= e && h("Serie #" + g + " does not have a domain column.");
		...
		V.Ur = function(a, b, c, d) {
			...
			if (1 < a.Jd[I] && 0 == a.qe[I]) a.qe = [a.Jd[0], a.Jd[a.Jd[I] - 1]];
			...
			for (m in g) for (var o = b.da(e(m, Ck)), i = b.da(e(m, Ti)), j = b.Hc(e(m, Yh)), j = hx(j, d), i = new wt({
				...
				rb: i,
				Qa: o
			}), j = b.da(e(m, Og)), f = b.da(e(m, Gm)), q = b.da(e(m, mh)), u = b.da(e(m, Ml)), o = b.Wh(e(m, vn), qu), y = b.za(e(m, Wj)[hb]([c + Wj, Wj])), D = b.ia(e(m, ki)[hb]([c + ki, ki]), Du, U), Y = b.da(e(m, Ym)[hb]([c + Ym, Ym]), 1), o = {
				style: o,
				b: i,
				Zq: j,
				ar: f,
		...
		V.Qs = function() {
			...
			case T:
				b = this.sa;
				b[F] == Ho && (a.fe == pn && h(r("Domain column cannot be of type string, it should be the X values on a continuous domain axis")), b.oi(a.fe, this.k));
			...
			for (var d = 0; d < a.v[I]; d++) for (var e = gq(0, this.Z[I]), f = Yp(e), g = Yp(e), i = 0; i < a.e[I]; i++) {
				...
				if (j[F] == Cg) {
					...
					if (W(D)) {
						...
						var G;
						c[F] == Ho ? (y = b[H](d, 0), G = c.j.U(y), c.Y(G), y = c.wd(G)) : (G = d, y = k);
						y && o.Y(Y);
						o = this.Qh(j, d, g[m], y);
						a.Vc && (g[m] = Y);
						m = {
		...
		V.Qh = function(a, b, c, d) {
			...
			m = 0;
			for (o = f[$c][I] - 1; m <= o; m++, o--) a = f[$c][m], q = f[$c][o], e(a, q, 0);
		...
		V.Is = function(a) {
			...
			else if (c = this.zk(g, c), this.ad = a && this.vs(e, c)) if (c = this.zk(g, d), !hp(c[0]) || 0 == c[0][I]) this.ad = n;
			else {
				this.ha = [];
				for (a = e; 0 < a[I];) {
					e = this.Pn(c, a);
		...
		V.Um = function(a, b, c, d, e, f, g, i, j, m, o, q, u, y, D, Y, L, X) {
			...
			G.Bh = new lq(e, g);
			G.Xc = 1 == aa;
			if (G[x]) if (G.Xc) G.oj = yr(i, new wr(e / 2, g / 2)), G.nj = k;
			else {
				D = j - g;
				aa = m - g;
				e = G.Bh;
		...
		V.bs = function() {
			...
			for (d = 0; d < i.d[I]; d++) b += g[d], a[J].d[v]({
				text: i.d[d],
				x: a.a[C],
				y: b,
				length: a.a[w]
		...
		V.$s = function() {
			...
			}), d = 0, e = 0, f = []; d < a[I] || e < b[I];) if (d < a[I] && !W(c.ng[d])) d++;
			else {
		...
		V.uu = function() {
			...
			if (a.f && a.f.ha && b.f && b.f.ha) {
				...
				for (a = 0; a < b[I]; ++a) {
					...
					if (d.ba && (d.ba = sq(d.ba), d.ba.S)) d.ba.S = sq(d.ba.S)
				}
			}
		};
		...
		V.Ut = function(a) {
			...
			if (this.Wj && this.Rh && b.f && b.f.kc) for (e = 0; e < b.f.kc[I]; e++) {
				f = b.f.kc[e];
				g = this.Wj[e];
				i = this.Rh[e];
		...
		function Nx(a, b, c, d, e, f, g) {
			...
			var j = d.x >= f.x ? 1 : -1,
				...
				Y = D + u[Q],
				g = {};
			if (c) c = new $(y.x, d.y + i / (i + u[Q] / 2) * (y.y - d.y)), y = new $(y.x + -1 * (d.x - y.x), c.y), c.x = s[z](c.x), c.y = s[z](c.y), y.x = s[z](y.x), y.y = s[z](y.y), g.Eb = 1 == j * m ? [c, d, y] : [y, d, c];
			...
			if (!(g.p[C] >= d && g.p[R] <= c)) {
				...
				if (j.p[C] >= d && j.p[R] <= c) g.p = j.p, g.Eb = j.Eb;
					...
					if (g.Eb && (m = new pt(d + 4, c - 4), o = new pt(j.Eb[0].x, j.Eb[2].x), q = new pt(g.Eb[0].x, g.Eb[2].x), !(m[O] <= q[O] && m.end >= q.end) && m[O] <= o[O] && m.end >= o.end)) g.p = j.p, g.Eb = j.Eb;
		...
		V.Yl = function(a, b, c) {
			...
			W(e) && this.Cs(a, e, c);
			a = b.X.Bb;
			if (W(a) && (c = this.Bs(c, a), b[gc][fc])) c.kg = this.ge.As(a, b[gc][fc])
		};
		...
		V.Mw = function(a, b, c) {
			...
			if (a.f && a.f[fc] == gk && W(b.f.s.lc)) {
				...
				if (W(o) && (i = this.eg(c, b, o), i.gf = k, a.Ic != U)) i.K = this.ge.Mh(b, o);
		...
		V.lo = function(a, b, c) {
			...
			if (e = a.C) b.C = b.C || {}, b.C.b = yt(e.b.O, 0.3), b.C.bb = b.bb[Dc](), b.C.ga = e.ga, b.C.ca = e.ca, b.C.ka = b.ka + b.b.H / 2, b.C.ua = b.ua + b.b.H / 2, d = sr(b.C.ga - 90), c = sr(b.C.ca - 90), b.C.Ba = kq(b.C.bb, lv(d, b.C.ka, b.C.ua)), b.C.Ib = kq(b.C.bb, lv(c, b.C.ka, b.C.ua));
			b.xd = a.xd;
			b.ce = a.ce;
		...
		V.Un = function(a) {
			...
			else for (a = 0; a < b.Zc[I]; ++a) Zp(c, b.Zc[a].w.annotation);
			return c
		};
		V.Tt = function() {
		...
		V.Pg = function(a) {
			if (a.B) {
				...
				if (a.xd || a.ce) i = c.ea.ej, c = new Et, c[rb](g.x + f.x, g.y + f.y), c.G(g.x + f.x, g.y + f.y + i), a.ce && (c.G(g.x + a.Ib.x, g.y + a.Ib.y + i), c.G(g.x + a.Ib.x, g.y + a.Ib.y)), a.xd && (c.G(g.x + a.Ba.x, g.y + a.Ba.y + i), c.G(g.x + a.Ba.x, g.y + a.Ba.y)), this.g.xa(c, a.sh, b);
		...
		V.pt = function(a) {
			...
			a && b && b.N == c.N && b[w] == c[w] && b[Q] == c[Q] && b.a.top == c.a.top && b.a[P] == c.a[P] && b.a[C] == c.a[C] && b.a[R] == c.a[R] ? (this.l = l, d = wp(), this.kd = {
				...
				ks: a.ws,
				Hn: n
			}, this.Qn(), Qr(this.kd.yk, Jn, Z(this.Qn, this)), this.kd.yk[O]()) : (this.l = c, this.In());
			this[ub]({
				type: Yl
			})
		};
		...
		V.yo = function() {
			...
			e = a.f.s;
			f = b.f.s;
			e.lc != f.lc && (W(f.lc) && d[v](this.li(ll, f.lc, l)), W(e.lc) && d[v](this.li(ml, e.lc, l)));
			a[kb].Od(b[kb]) || d[v]({
				type: tm
			});
			return d
